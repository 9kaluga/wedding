const ScheduleSection = () => {
  const events = [
    {
      time: "Во час, когда солнце в зените (15:15)",
      date: "В год 7535 от сотворения мира (18.09.2026)",
      title: "Связывание судеб венцом брака",
      place: "В тереме государственном (ЗАГС)",
      guests: "Молодожёны да родичи",
    },
    {
      time: "Когда вечерняя заря светится (16:30)",
      date: "В год 7535 от сотворения мира (18.09.2026)",
      title: "Путь к терему новому (Трансфер)",
      place: "Из терема государственного (ЗАГС)",
      guests: "Отъезд молодых да родичей в терем праздничный",
    },
    {
      time: "Когда солнце клонится к закату (17:30)",
      date: "В год 7535 от сотворения мира (18.09.2026)",
      title: "Приём гостей",
      place: "В тереме новобрачных",
    ...
    {
      time: "Когда звёзды на небе сияют (24:00)",
      date: "В год 7535 от сотворения мира (18.09.2026)",
    ...
    {
      time: "Когда солнце в зените стоит (13:00)",
      date: "В год 7535 от сотворения мира (19.09.2026)",
